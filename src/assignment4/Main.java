...
//            final GraphPoet nimoy = new GraphPoet(new File("src/Assignment4TestCases/Test1/corpus.txt"));
//            System.out.println(nimoy.poem(new File("src/Assignment4TestCases/Test1/input.txt")));
